  ...
  return (
    <div className='w-[70%] flex h-full justify-between items-center m-auto py-[10%] '>
      ...
      <div className="content w-[50%]">
        ...
        <p className='text-zinc-800'>Your perfect pack for everyday use and walks in the forest. Stash your laptop (up to 15 inches) in the padded sleeve, your everyday",
