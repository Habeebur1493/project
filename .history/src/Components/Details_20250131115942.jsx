  ...
  return (
    <div className='w-[70%] flex h-full justify-between items-center m-auto py-[10%] '>
      ...
      <div className="content w-[50%]">
        ...
        <p className='text-zinc-800 text-1xl mb-5'>Your perfect pack for everyday use and walks in the forest. Stash your laptop (up to 15 inches) in the padded sleeve, your everyday",
        "category": "men's clothing</p>
        <Link className='mr-5 py-4 px-5 border rounded text-white text-xl bg-blue-600'>
        Edit</Link>
